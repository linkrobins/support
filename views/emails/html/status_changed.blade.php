<x-mail::html.notification>
    <x-slot:body>
        <p>{{ $translator->trans('linkrobins-support.email.status_changed_body', ['status' => $translator->trans(\LinkRobins\Support\SupportTicket::statusLabelKey($blueprint->status))]) }}</p>
